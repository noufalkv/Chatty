...
export const getReactionsByUsernameMock = rest.get(
  `${BASE_URL}/post/reactions/username/Danny`,
  (req, res, ctx) => {
    const result = {
...
export const getPostReactionsMock = rest.get(
  `${BASE_URL}/post/reactions/6027f77087c9d9ccb1555268`,
  (req, res, ctx) => {
    const result = {
